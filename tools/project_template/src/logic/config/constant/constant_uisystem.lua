...
-- windows 下字体不能太模糊
if g_application:getTargetPlatform() == 0 and rich_label_font_size < 25 then
    rich_label_font_size = 25
end
...
default_control_value = {
    ...
    ['RepeatSprite'] = {
        ...
        ['opacity'] = 255,
        ['blendFun'] = cc.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA),
        ['addressMode'] = REPEAT_SPRITE_ADDRESS_MODE.GL_REPEAT
    },
    ['RichLabel'] = {
        ['font_size'] = 24,
        ['max_width'] = 0,
    ...
    ['CCLabelAtlas'] = {
        ['fntFile'] = 'gui/fonts/atlas_num.plist',
        ['text'] = '',
        ['color'] = 0xffffff,
        ['opacity'] = 255,
    },
    ...
    ['CCClippingNode'] = {
        ['displayFrame'] = {plist = '', path = 'gui/default/clip_spt.png'},
        ['alphaThreshold'] = 0.9,
        ['inverted'] = false,
    },
    ...
    ['CCCombobox'] = {
        ...
        ['text'] = 'combobox',
        ['combobox_template'] = 'default/ctrls/combobox/ctrl_combobox',
        ['combobox_popup_layer_template'] = 'default/ctrls/combobox/ctrl_combobox_popup_layer',
    },
    ['CCBFile'] = {
    ...
    ['CCHorzAsyncList'] = {
        ['singleItemReverseLoadOrder'] = false,
    },
    ['CCVerAsyncList'] = {
        ['singleItemReverseLoadOrder'] = false,
    },
    ...
    ['Node3D'] = {
        ...
        ['scale_z'] = 1,
        ['globalZorder'] = 0,
        ['cameraMask'] = cc.CameraFlag.DEFAULT,
    },
    ['PerspectiveCamera'] = {
        ['fieldOfView'] = 60,
