...
cc.SHADER_UI_GRAY_SCALE     = 'ShaderUIGrayScale'
cc.SHADER_POSITION_TEXTURE_COLOR_NO_MVP  = 'ShaderPositionTextureColor_noMVP'
cc.SHADER_POSITION_TEXTURE_COLOR_NO_MVP_BLUR = 'ShaderPositionTextureColor_noMVP_Blur'
cc.SHADER_LABEL_UI_GRAY_SCALE = 'ShaderLabelUIGrayScale'
cc.SHADER_LABEL_NORMAL_EXT = 'ShaderLabelNormalExt'
